...
class trPdfnav extends StatefulWidget {
  const trPdfnav({Key? key}) : super(key: key);

  @override
  State<trPdfnav> createState() => _trPdfnavState();
}

class _trPdfnavState extends State<trPdfnav> {
  @override
  ...
  child: StreamBuilder(
     stream: FirebaseFirestore.instance.collection("godsbooks").where('language',isEqualTo: 'tr').snapshots(),
